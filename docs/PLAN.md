...
| ~3s window | Response budget (1.5s): reply directly if fast, else defer (type 5) and edit in the result — or an explicit error — via interaction webhook; DB warm-up before listening | unit ✅ / live ✅ (forced with budget=1: deferred + edited) |
